...
class ButtonsTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// The value of the [width] applied to each button.
  final double? width;
...
class _ButtonsTabBarState extends State<ButtonsTabBar> with TickerProviderStateMixin {
  ...
  Widget _buildButton(
    ...
    final TextStyle? textStyle = TextStyle.lerp(widget.unselectedLabelStyle ?? const TextStyle(color: Colors.black),
        widget.labelStyle ?? const TextStyle(color: Colors.white), animationValue);
        ...
        child: Ink(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                tab.icon != null
                    ? IconTheme.merge(data: IconThemeData(size: 24.0, color: foregroundColor), child: tab.icon!)
                    : Container(),
                SizedBox(
