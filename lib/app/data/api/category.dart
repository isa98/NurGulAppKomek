...
class CategoryApi {
  ...
  static Future<List<CategoryModel>> getCategories(Map<String, dynamic> params) async {
    ...
    if (_categories.isEmpty) {
      try {
        ...
        final List<CategoryModel> categories = CategoryModel.listFromJson(list.first['children']);
